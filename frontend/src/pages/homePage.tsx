...
export default function HomePage() {
  ...
  const defaultImage =
    "https://www.artic.edu/iiif/2/2d484387-2509-5e8e-2c43-22f9981972eb/full/1200,/0/default.jpg";
          ...
          <div className="relative overflow-hidden bg-white dark:bg-dark-bg rounded">
            ...
            <div className="flex flex-col items-center justify-start py-8 md:py-24 space-y-8 mx-auto px-4 md:px-8 max-w-2xl text-center">
              <div className="space-y-4">
                <h1 className="heading-lg text-5xl md:text-6xl lg:text-6xl text-gallery-text dark:text-dark-text leading-none">
                  Art Institute
                </h1>
                <p className="text-base md:text-lg text-gallery-muted dark:text-dark-muted font-light leading-relaxed">
                  Explore over 130,000 artworks from one of the world's most
                  prestigious collections. Discover masterpieces from artists
          ...
          <section className="bg-white dark:bg-dark-bg py-16 md:py-24">
            <div className="page-container">
              <div className="max-w-2xl mx-auto text-center space-y-6">
                ...
                <p className="text-base md:text-lg text-gallery-muted dark:text-dark-muted font-light leading-relaxed">
                  The Art Institute of Chicago houses one of the world's finest
                  collections of fine art. From ancient Egyptian artifacts to
                  contemporary installations, our digital collection brings
                  masterpieces directly to you.
                </p>
                <p className="text-sm text-gallery-muted dark:text-dark-muted font-light">
                  Navigate through curated collections, discover artists, and
                  dive into the stories behind each piece.
                </p>
              </div>
            </div>
          </section>
